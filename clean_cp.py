...
def clean(dbname):
    ...
    while True:
        ...
        if cur.rowcount < BATCHSIZE:
            ...
            print (f"DEBUG {dbname} tasks_archive deleted: {cur.rowcount} rows", flush=True)
    ...
    while True:
        ...
        if cur.rowcount < BATCHSIZE:
            ...
            print (f"DEBUG {dbname} stream_counters deleted: {cur.rowcount} rows", flush=True)
    ...
    while True:
        ...
        if cur.rowcount < BATCHSIZE:
            ...
            print (f"DEBUG {dbname} tasks_history deleted: {cur.rowcount} rows", flush=True)
    conn.close()
